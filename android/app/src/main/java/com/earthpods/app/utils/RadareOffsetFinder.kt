...
class RadareOffsetFinder(context: Context) {
    companion object {
        ...
        private const val HOOK_OFFSET_PROP = "persist.earthpods.hook_offset"
        private const val CFG_REQ_OFFSET_PROP = "persist.earthpods.cfg_req_offset"
        private const val CSM_CONFIG_OFFSET_PROP = "persist.earthpods.csm_config_offset"
        private const val PEER_INFO_REQ_OFFSET_PROP = "persist.earthpods.peer_info_req_offset"
        private const val SDP_OFFSET_PROP = "persist.earthpods.sdp_offset"
